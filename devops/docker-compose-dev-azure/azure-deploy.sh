...
resourcename="casemanagementsystem"  # lower case, only
resourcegroup="casemanagementsystem_rg"
...
# git clone https://github.com/apilogicserver/casemanagementsystem.git
...
az group create --name casemanagementsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group casemanagementsystem_rg --sku S1 --is-linux
az container create --resource-group casemanagementsystem_rg --name casemanagementsystem --image apilogicserver/casemanagementsystem:latest --dns-name-label casemanagementsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//casemanagementsystem.westus.azurecontainer.io:5656'
