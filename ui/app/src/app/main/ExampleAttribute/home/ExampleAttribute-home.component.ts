...
@Component({
  selector: 'ExampleAttribute-home',
  templateUrl: './ExampleAttribute-home.component.html',
  styleUrls: ['./ExampleAttribute-home.component.scss']
})
export class ExampleAttributeHomeComponent implements AfterViewInit {
