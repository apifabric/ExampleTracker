...
@Component({
  selector: 'ExampleAuthor-home',
  templateUrl: './ExampleAuthor-home.component.html',
  styleUrls: ['./ExampleAuthor-home.component.scss']
})
export class ExampleAuthorHomeComponent implements AfterViewInit {
