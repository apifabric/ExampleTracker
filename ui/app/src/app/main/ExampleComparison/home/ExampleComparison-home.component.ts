...
@Component({
  selector: 'ExampleComparison-home',
  templateUrl: './ExampleComparison-home.component.html',
  styleUrls: ['./ExampleComparison-home.component.scss']
})
export class ExampleComparisonHomeComponent implements AfterViewInit {
