...
@Component({
  selector: 'RuleAuthor-home',
  templateUrl: './RuleAuthor-home.component.html',
  styleUrls: ['./RuleAuthor-home.component.scss']
})
export class RuleAuthorHomeComponent implements AfterViewInit {
